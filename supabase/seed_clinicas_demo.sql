...
declare
  ...
  v_sl_cat   constant uuid := '734c7500-0000-0000-0000-000000000010';
  v_sl_a_glu constant uuid := '734c7500-0000-0000-0000-000000000020';
  v_sl_st    constant uuid := '734c7500-0000-0000-0000-000000000030';

  v_cm_cat   constant uuid := '636d6400-0000-0000-0000-000000000010';
  v_cm_a_hb  constant uuid := '636d6400-0000-0000-0000-000000000020';
  v_cm_a_glu constant uuid := '636d6400-0000-0000-0000-000000000021';
  v_cm_a_tgo constant uuid := '636d6400-0000-0000-0000-000000000022';
  v_cm_st    constant uuid := '636d6400-0000-0000-0000-000000000030';

  v_p_cm_1 constant uuid := '636d6400-0000-0000-0000-000000000101';
  v_p_cm_2 constant uuid := '636d6400-0000-0000-0000-000000000102';
  v_p_cm_3 constant uuid := '636d6400-0000-0000-0000-000000000103';
  v_p_cm_4 constant uuid := '636d6400-0000-0000-0000-000000000104';

  v_o_cm_1 constant uuid := '636d6400-0000-0000-0000-000000000201';
  v_o_cm_2 constant uuid := '636d6400-0000-0000-0000-000000000202';
  v_o_cm_3 constant uuid := '636d6400-0000-0000-0000-000000000203';

  v_i_o_cm_1_hem constant uuid := '636d6400-0000-0000-0000-000000000301';
  v_i_o_cm_1_glu constant uuid := '636d6400-0000-0000-0000-000000000302';
  v_i_o_cm_2_lip constant uuid := '636d6400-0000-0000-0000-000000000303';
  v_i_o_cm_3_lip constant uuid := '636d6400-0000-0000-0000-000000000304';

  v_smp_cm_1 constant uuid := '636d6400-0000-0000-0000-000000000401';
  v_smp_cm_2 constant uuid := '636d6400-0000-0000-0000-000000000402';

  v_inv_cm_2 constant uuid := '636d6400-0000-0000-0000-000000000501';
  v_inv_cm_3 constant uuid := '636d6400-0000-0000-0000-000000000502';
begin
  select u.id, u.email
